...
Zepto(function ($) {
    ...
    LoadImages([
        ...
        "images/p01a.png?v=1",
        "images/p02a.png?v=1",
        "images/p03a4.png?v=1",
        "images/p04a.png?v=1",
        "images/p05a.png?v=1",
        "images/p06a.png?v=1",
        "images/p07a.png?v=1",
        "images/p08a3.png?v=2",
        "images/p09a.png?v=1",
        "images/p10a.png?v=1",
        "images/p11a.png?v=1",
        "images/p12a1.png?v=1",
        "images/p12b.png?v=1",
        "images/p12c.png?v=1",
        "images/p12d.png?v=1",
        "images/p13a1.png?v=1",
        "images/p14a1.png?v=1",
        "images/p15a.png?v=1",
        "images/qr_code.png?v=1",
        "images/bt_booking_normal.png?v=1",
        "images/bt_booking_pressed.png?v=1"
    ], function () {
        setTimeout(function () {
    ...
    function success() {
        ...
        page_n = newM;
        start = true;
        $('.shrinkLabel').toggle($('.m-page').length != newM);
